spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red> Vui Lòng Chơi Tạm Khi Đang Update Bản Kia<Color=/>"):Display()
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow>Update Xong Sẽ Về Như cũ<Color=/>"):Display()
end)
----------------------------------------------------------------------------------------------------------------------------------------------  
...
--------------------------------------------------------------------
local Library = Update:Window("DUY MOD GAME","")
------------------------------------------
